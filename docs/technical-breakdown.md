...
## Encyclopedic summary (neutral prose, adaptable for a wiki)
...
*(Note: Wikipedia article space requires reliable secondary sources and discourages original research; the prose above is best used in a project README, a wiki such as PCGamingWiki, or as the basis for content once a citable source exists.)*
